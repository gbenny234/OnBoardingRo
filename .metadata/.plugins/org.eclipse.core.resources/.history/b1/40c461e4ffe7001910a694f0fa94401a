...
public abstract class SignUpPatientPageBot {
    ...
    /*
     * This function returns locator for the error message
     * indicating invalid email address
     */	
    ...
    /*
     * This function returns locator for the welcome header in the
     * welcomepage
     */	
    ...
    /*
     * This function returns locator for the error message
     * shown as a result of empty email address. 
     */	
    ...
    /*
     * This function returns locator for the error message
     * shown as a result of first name field being empty. 
     */	
    ...
    /*
     * This function returns locator for the error message
     * shown as a result of invalid password. 
     */	
    ...
    /*
     * This function returns locator for the error message
     * shown as a result of privacy box not checked. 
     */	
